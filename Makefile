...
pytalic2_ui.py: $(PROJECT)/pytalic2.ui
	pyuic5 $(PROJECT)/pytalic2.ui -o $(PROJECT)/pytalic2_ui.py.BAD
	sed 's/import pytalic2_rc/import shared.pytalic2_rc/' $(PROJECT)/pytalic2_ui.py.BAD > $(PROJECT)/pytalic2_ui.py
