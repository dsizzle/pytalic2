...
class EditInterface(QtGui.QMainWindow):
	...
	def create_menu(self):
		...
		self.edit_menu.addAction(self.editUndo)
		self.tool_bar.addAction(self.editUndo)
		...
		self.edit_menu.addAction(self.editRedo)
		self.tool_bar.addAction(self.editRedo)
		...
		self.edit_menu.addAction(self.editCut)
		self.tool_bar.addAction(self.editCut)
		...
		self.edit_menu.addAction(self.editCopy)
		self.tool_bar.addAction(self.editCopy)
		...
		self.edit_menu.addAction(self.editPaste)
		self.tool_bar.addAction(self.editPaste)
		...
		self.strokeDelete.triggered.connect(self.__parent.deleteStrokes_cb)
