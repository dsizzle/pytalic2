...
class EditInterface(QtGui.QMainWindow):
	...
	def create_ui(self):
		...
		QtCore.QObject.connect(self.base_height_spin, QtCore.SIGNAL("valueChanged(double)"), self.__parent.guide_base_height_changed_cb)
		...
		QtCore.QObject.connect(self.cap_height_spin, QtCore.SIGNAL("valueChanged(double)"), self.__parent.guide_cap_height_changed_cb)
		...
		QtCore.QObject.connect(self.ascent_height_spin, QtCore.SIGNAL("valueChanged(double)"), self.__parent.guide_ascent_changed_cb)
		...
		QtCore.QObject.connect(self.descent_height_spin, QtCore.SIGNAL("valueChanged(double)"), self.__parent.guide_descent_changed_cb)
		...
		QtCore.QObject.connect(self.angle_spin, QtCore.SIGNAL("valueChanged(int)"), self.__parent.guide_angle_changed_cb)
		...
		QtCore.QObject.connect(self.gap_height_spin, QtCore.SIGNAL("valueChanged(double)"), self.__parent.guide_gap_height_changed_cb)
		...
		QtCore.QObject.connect(self.nominal_width_spin, QtCore.SIGNAL("valueChanged(double)"), self.__parent.guide_nominal_width_changed_cb)
		...
		QtCore.QObject.connect(self.guidesColorButton, QtCore.SIGNAL("valueChanged(QColor)"), self.__parent.guide_color_changed_cb)
		...
		QtCore.QObject.connect(self.char_set_nib_angle_spin, QtCore.SIGNAL("valueChanged(double)"), self.__parent.char_set_nib_angle_changed_cb)
		...
		QtCore.QObject.connect(self.char_width_spin, QtCore.SIGNAL("valueChanged(double)"), self.__parent.char_width_changed_cb)
		...
		QtCore.QObject.connect(self.left_space_spin, QtCore.SIGNAL("valueChanged(double)"), self.__parent.char_left_space_changed_cb)
		...
		QtCore.QObject.connect(self.right_space_spin, QtCore.SIGNAL("valueChanged(double)"), self.__parent.char_right_space_changed_cb)
		...
		QtCore.QObject.connect(self.behavior_combo, QtCore.SIGNAL("currentIndexChanged(int)"), self.__parent.vert_behavior_combo_changed_cb)
